<template>
    <div class="content-page uk-body">
        <div class="calendar">
            <div class="header">
              <button class="year-less" @click="preYear"> << </button>
              <button class="month-less" @click="prevMonth"> < </button>
              <h4>{{year}}年{{month}}月</h4>
              <button class="month-add" @click="nextMonth"> > </button>
              <button class="year-add" @click="nextYear"> >> </button>
            </div>

            <table class="sign_tab" border="1px" cellpadding="0px" cellspacing="0px">
                <thead>
                <tr>
                    <th>日</th>
                    <th>一</th>
...
.calendar button.year-less {left: 40px;}
.calendar button.year-add   {right: 40px;}
...
.calendar .sign_tab th{text-align: center;font-weight: 700;}
...
.calendar .sign_tab td.cur_day{background-color: #dbe814;color: #4edeaf;}
.checkin-btn{
  display: block;
  width:90%;
  margin:0 auto;
